...
const repo = process.env.DECAP_REPO || 'SunnyBuilds/amazon-affiliate-blog';
const authBaseUrl =
  process.env.DECAP_AUTH_BASE_URL || process.env.CF_PAGES_URL || 'https://amazon-affiliate-blog.pages.dev';
